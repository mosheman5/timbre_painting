...
import numpy as np
import torch
from crepe.core import to_local_average_cents, to_viterbi_cents
...
# def py_to_local_average_cents(salience, center=None):
#     """
#     find the weighted average cents near the argmax bin
#     """
#     if not hasattr(to_local_average_cents, 'cents_mapping'):
#         # the bin number-to-cents mapping
#         to_local_average_cents.mapping = torch.from_numpy(
...
#     if salience.ndim == 2:
#         return torch.cat([to_local_average_cents(salience[i, :]).view(1) for i in
